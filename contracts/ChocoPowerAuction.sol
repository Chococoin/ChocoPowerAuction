...
contract ChocoPowerAuction{
    ...
    function bid(Fund _kind) public payable isOpen isHigh returns(bool){
        closeIt();
        ...
        pendingReturns[highestBidder].amount = highestBid;
    ...
    function chocoPowerFunding () public payable {
